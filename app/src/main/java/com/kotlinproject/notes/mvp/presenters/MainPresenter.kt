...
import com.kotlinproject.notes.mvp.views.MainView
import com.kotlinproject.notes.utils.getNotesSortMethodName
import com.kotlinproject.notes.utils.setNotesSortMethod
...
class MainPresenter : MvpPresenter<MainView>() {
    ...
    fun onNoteDelete(action: NoteDeleteAction) {
        Log.d("Notes", "onDeleted" + action.noteId)
        val notePosition = getNotePositionById(action.noteId)
